...
export function SendIcon({ ic }: any) {
	return (
...
export function BulldozeIcon({ ic }: any) {
	return (
		<SvgIcon className={ic}>
...
export function CityIcon({ ic }: any) {
	return (
		<SvgIcon className={ic}>
...
export function CommercialIcon({ ic }: any) {
	return (
		<SvgIcon className={ic}>
...
export function IndustrialIcon({ ic }: any) {
	return (
		<SvgIcon className={ic}>
...
export function LogOutIcon({ ic }: any) {
	return (
		<SvgIcon className={ic}>
...
export function NuclearIcon({ ic }: any) {
	return (
		<SvgIcon className={ic}>
...
export function QuestionIcon({ ic }: any) {
	return (
		<SvgIcon className={ic} style={{fontSize: "1em", color: "#fff", textDecoration: "none"}}>
...
export function SunMoonIcon({ ic }: any) {
	return (
		<SvgIcon className={ic} style={{fontSize: "1em", color: "#fff", textDecoration: "none"}}>
...
export function GithubIcon({ ic }: any) {
	return (
		<a href='https://github.com/cnqso/greenshift-site' target='_blank' rel='noreferrer' className={ic} style={{fontSize: "1em", color: "#fff", textDecoration: "none"}}>
...
export function WebsiteIcon({ ic }: any) {
	return (
		<a href='https://cnqso.com/' target='_blank' rel='noreferrer' className={ic} style={{fontSize: "1em", color: "#fff", textDecoration: "none"}}>
			<SvgIcon sx={{fontSize: '1em'}}>
...
export function Unlocked({ ic }: any) {
	return (
		<span>
			<SvgIcon sx={{fontSize: '1.05em'}}>
...
export function Plot({ linear }: any) {
	return (
		<span>
			<SvgIcon sx={{fontSize: '1em'}}>
